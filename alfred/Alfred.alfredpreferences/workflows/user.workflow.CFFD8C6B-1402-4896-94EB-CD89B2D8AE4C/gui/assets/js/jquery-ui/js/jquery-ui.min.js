            ...
            ? this.each(function () {
                ...
                return n
                  ? t.isFunction(n[a]) && '_' !== a.charAt(0)
                    ? ((s = n[a].apply(n, h)),
                      s !== n && s !== e ? ((l = s && s.jquery ? l.pushStack(s.get()) : s), !1) : e)
                    ...
                    (i.now = Math.round(e)),
                      'height' !== i.prop
                        ...
                        : 'content' !== h.options.heightStyle &&
                          ((i.now = Math.round(n - t.outerHeight() - d)), (d = 0));
                  }
                }),
                undefined)
              : t.animate(i, o, r, v)
  ...
  e.widget('ui.button', {
    ...
    _create: function () {
      ...
      var n = this,
        ...
        h = r ? '' : 'ui-state-active';
      null === o.label &&
        (o.label = 'input' === this.type ? this.buttonElement.val() : this.buttonElement.html()),
    ...
    _resetButton: function () {
      ...
      s.primary || s.secondary
        ? (this.options.text &&
            o.push('ui-button-text-icon' + (a ? 's' : s.primary ? '-primary' : '-secondary')),
          s.primary &&
  ...
  e.extend(i.prototype, {
    ...
    _attachments: function (t, i) {
      ...
      i.append && i.append.remove(),
        r &&
          ((i.append = e("<span class='" + this._appendClass + "'>" + r + '</span>')),
    ...
    _autoSize: function (e) {
      if (this._get(e, 'autoSize') && !e.inline) {
        ...
        r.match(/[DM]/) &&
          ...
          n.setDate(
            t(this._get(e, r.match(/DD/) ? 'dayNames' : 'dayNamesShort')) + 20 - n.getDay()
          )),
      ...
      return 2 === arguments.length && 'string' == typeof a
        ...
        : ((r = a || {}),
          ...
          h &&
            ...
            'disabled' in r &&
              (r.disabled ? this._disableDatepicker(i) : this._enableDatepicker(i)),
        ...
        switch (t.keyCode) {
          ...
          case 13:
            return (
              ...
              i
                ? ((a = e.datepicker._formatDate(n)), i.apply(n.input ? n.input[0] : null, [a, n]))
                : e.datepicker._hideDatepicker(),
              !1
            );
          case 27:
    ...
    _adjustDate: function (t, i, a) {
      ...
      this._isDisabledDatepicker(s[0]) ||
        (this._adjustInstDate(n, i + ('M' === a ? this._get(n, 'showCurrentAtPos') : 0), a),
    ...
    _selectMonthYear: function (t, i, a) {
      var s = e(t),
        n = this._getInst(s[0]);
      (n['selected' + ('M' === a ? 'Month' : 'Year')] = n['draw' + ('M' === a ? 'Month' : 'Year')] =
    ...
    parseDate: function (i, a, s) {
      ...
      if (
        (-1 === f
          ...
          : 100 > f &&
            (f +=
              new Date().getFullYear() - (new Date().getFullYear() % 100) + (l >= f ? 0 : -100)),
        k > -1)
      )
        for (_ = 1, v = k; ; ) {
    ...
    _determineDate: function (t, i, a) {
      var s = function (e) {
        ...
        n = function (i) {
          ...
          for (
            var s = (i.toLowerCase().match(/^c/) ? e.datepicker._getDate(t) : null) || new Date(),
              n = s.getFullYear(),
              r = s.getMonth(),
              o = s.getDate(),
        ...
        for (w = '', this.maxRows = 4, M = 0; q[1] > M; M++) {
          ...
          for (
            ...
            (T = (b + h) % 7),
              (N +=
                '<th' +
                ((b + h + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : '') +
                '>' +
                "<span title='" +
                d[T] +
                "'>" +
            ...
            for (
              ...
              (j = f ? f.apply(e.input ? e.input[0] : null, [F]) : [!0, '']),
                ...
                (O +=
                  ...
                  ((F.getTime() === C.getTime() && Z === e.selectedMonth && e._keyEvent) ||
                  ...
                  (K && !_
                    ...
                    : ' ' +
                      j[1] +
                      (F.getTime() === V.getTime() ? ' ' + this._currentClass : '') +
                      (F.getTime() === W.getTime() ? ' ui-datepicker-today' : '')) +
                  "'" +
          ...
          Z++,
            ...
            (I +=
              ...
              (Q
                ? '</div>' +
                  (q[0] > 0 && M === q[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : '')
                : '')),
            (w += I);
        }
        y += w;
  ...
  e.widget('ui.dialog', {
    ...
    _size: function () {
      ...
      this.element.show().css({ width: 'auto', minHeight: 0, maxHeight: 'none', height: 0 }),
        ...
        (e = this.uiDialog.css({ height: 'auto', width: a.width }).outerHeight()),
      ...
      var s = 'absolute' === e ? 1 : -1,
        n =
          ...
          (this.scrollParent[0] !== document &&
            ...
            : this.offsetParent;
      return (
        this.offset.scroll || (this.offset.scroll = { top: n.scrollTop(), left: n.scrollLeft() }),
        {
          top:
            i.top +
          ...
          (r = p.snapElements[u].left),
            ...
            !t.contains(p.snapElements[u].item.ownerDocument, p.snapElements[u].item)
              ...
              : ('inner' !== g.snapMode &&
                  ...
                  n &&
                    (i.position.top =
                      p._convertPositionTo('relative', { top: c, left: 0 }).top - p.margins.top),
                  a &&
                    (i.position.left =
                      p._convertPositionTo('relative', {
                        top: 0,
                  ...
                  o &&
                    (i.position.left =
                      p._convertPositionTo('relative', { top: 0, left: l }).left - p.margins.left)),
                (d = s || n || a || o),
                'outer' !== g.snapMode &&
                  ((s = f >= Math.abs(h - v)),
                  (n = f >= Math.abs(c - b)),
                  ...
                  s &&
                    (i.position.top =
                      p._convertPositionTo('relative', { top: h, left: 0 }).top - p.margins.top),
                  n &&
                    (i.position.top =
                      p._convertPositionTo('relative', {
                  ...
                  a &&
                    (i.position.left =
                      p._convertPositionTo('relative', { top: 0, left: r }).left - p.margins.left),
                  o &&
                    (i.position.left =
                      p._convertPositionTo('relative', {
                        top: 0,
    ...
    (t.ui.intersect = function (t, i, s) {
      ...
      switch (s) {
        ...
        case 'pointer':
          return (
            (n =
              (t.positionAbs || t.position.absolute).left + (t.clickOffset || t.offset.click).left),
            (a =
        ...
        t: for (s = 0; a.length > s; s++)
          if (
            !(
              ...
              (e && !a[s].accept.call(a[s].element[0], e.currentItem || e.element))
            )
          ) {
            ...
            if (!this.options.disabled && !this.greedyChild && this.visible) {
              ...
              r &&
                (this.options.greedy &&
                  ...
                  a.length &&
                    ((s = t.data(a[0], 'ui-droppable')), (s.greedyChild = 'isover' === r))),
        ...
        return (
          ...
          f(l, function (t, a) {
            var o,
              ...
              h = a.space || 'rgba';
            return l
              ? ((o = s[h](l)), (s[c[h].cache] = o[c[h].cache]), (n = s._rgba = o._rgba), !1)
              : e;
          }),
              ...
              f(a.props, function (t, n) {
                ...
                null !== h &&
                  (null === o
                    ? (l[a] = h)
                    : (c.mod &&
                        (h - o > c.mod / 2 ? (o += c.mod) : o - h > c.mod / 2 && (o -= c.mod)),
                      (l[a] = i((h - o) * e + o, n))));
              }),
              this[n](l)
            );
          ...
          toggleClass: (function (i) {
            return function (s, n, a, o, r) {
              return 'boolean' == typeof n || n === e
                ? a
                  ? t.effects.animateClass.call(this, n ? { add: s } : { remove: s }, a, o, r)
      ...
      for (l = m.top + a * _, c = a - (u - 1) / 2, o = 0; d > o; o++)
        (r = m.left + o * v),
          ...
          p
            ...
            .animate(
              { left: r + (g ? 0 : h * v), top: l + (g ? 0 : c * _), opacity: g ? 1 : 0 },
              e.duration || 500,
              e.easing,
              s
            );
  ...
  (t.effects.effect.puff = function (e, i) {
    ...
    (t.effects.effect.scale = function (e, i) {
      ...
      (n.effect = 'size'),
        ...
        (n.from =
          e.from || ('show' === a ? { height: 0, width: 0, outerHeight: 0, outerWidth: 0 } : h)),
        (n.to = {
          height: h.height * c.y,
          width: h.width * c.x,
    ...
    (t.effects.effect.size = function (e, i) {
      ...
      'show' === p && o.show(),
        ...
        'toggle' === e.mode && 'show' === p
          ...
          : ((o.from = e.from || ('show' === p ? b : s)), (o.to = e.to || ('hide' === p ? b : s))),
        (a = {
  ...
  t.widget('ui.resizable', t.ui.mouse, {
    ...
    _mouseStart: function (i) {
      ...
      return (
        ...
        o.containment &&
          ((s += t(o.containment).scrollLeft() || 0), (n += t(o.containment).scrollTop() || 0)),
      ...
      stop: function (e) {
        var i = t(this).data('ui-resizable'),
          ...
          l =
            ...
            null,
          c =
            parseInt(i.element.css('top'), 10) + (i.position.top - i.originalPosition.top) || null;
      ...
      resize: function (e) {
        ...
        d[0] !== document && /static/.test(d.css('position')) && (u = h),
          l.left < (o._helper ? h.left : 0) &&
            ((o.size.width =
              o.size.width + (o._helper ? o.position.left - h.left : o.position.left - u.left)),
          ...
          (i = Math.abs(
            (o._helper ? o.offset.left - u.left : o.offset.left - u.left) + o.sizeDiff.width
          )),
          (s = Math.abs(
            (o._helper ? o.offset.top - u.top : o.offset.top - h.top) + o.sizeDiff.height
          )),
      ...
      resize: function () {
        ...
        (i.grid = r),
          ...
          /^(se|s|e)$/.test(o)
            ...
            : /^(ne)$/.test(o)
            ? ((e.size.width = d), (e.size.height = p), (e.position.top = a.top - u))
            : /^(sw)$/.test(o)
            ? ((e.size.width = d), (e.size.height = p), (e.position.left = a.left - c))
            : (p - l > 0
                ? ((e.size.height = p), (e.position.top = a.top - u))
                : ((e.size.height = l), (e.position.top = a.top + n.height - l)),
              d - h > 0
                ? ((e.size.width = d), (e.position.left = a.left - c))
                : ((e.size.width = h), (e.position.left = a.left + n.width - h)));
      }
    });
})(jQuery);
(function (t) {
        ...
        return (
          ...
          this.selectees.each(function () {
            ...
            i &&
              ...
              ('touch' === n.tolerance
                ? (h = !(i.left > r || a > i.right || i.top > l || o > i.bottom))
                : 'fit' === n.tolerance &&
      ...
      this.options.values && this.options.values.length
        ? ((s = this.values(e ? 0 : 1)),
          ...
          i !== this.values(e) &&
            ((n = this.values()),
            (n[e] = i),
            (a = this._trigger('slide', t, { handle: this.handles[e], value: i, values: n })),
            (s = this.values(e ? 0 : 1)),
            a !== !1 && this.values(e, i)))
        : i !== this.value() &&
          ((a = this._trigger('slide', t, { handle: this.handles[e], value: i })),
          a !== !1 && this.value(i));
    },
    _stop: function (t, e) {
      var i = { handle: this.handles[e], value: this.value() };
    ...
    _handleEvents: {
      keydown: function (i) {
        ...
        switch (
          ((o = this.options.step),
          (n = a =
            this.options.values && this.options.values.length ? this.values(r) : this.value()),
          i.keyCode)
        ) {
          case t.ui.keyCode.HOME:
            a = this._valueMin();
        ...
        this.anchors.each(function (i, n) {
          ...
          s(n)
            ...
            : ((r = e._tabId(l)),
              (a = '#' + r),
              (o = e.element.find(a)),
              o.length || ((o = e._createPanel(r)), o.insertAfter(e.panels[i - 1] || e.tablist)),
  ...
  t.widget('ui.tooltip', {
    ...
    _open: function (i, s, n) {
      ...
      if (n) {
        ...
        s.is('[title]') &&
          (i && 'mouseover' === i.type ? s.attr('title', '') : s.removeAttr('title')),
          (a = this._tooltip(s)),
          e(s, a.attr('id')),
