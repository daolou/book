...
作为一名开发人员，拿到全新的 mac，首先要做的就是搭建适合自己的环境了。
...
若乱码，请安装[Powerline](https://github.com/powerline/fonts)字体，然后配置下 iTerm2 的字体：Preferences -> Profile -> Text -> Change Font ->选择 12pt Meslo LG S Regular for Powerline，重启即可。

分享一下我的配置：[oh_my_zsh](https://github.com/Mr-jiangzhiguo/book/tree/master/zsh/oh_my_zsh)

补充一句：嫌弃 oh-my-zsh 太慢不想用，也可以自己配 zsh，推荐[fast](https://github.com/Mr-jiangzhiguo/book/tree/master/zsh/fast)
